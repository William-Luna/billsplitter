      ...
      <Paper elevation={2} sx={{ p: 2 }}>
        <form onSubmit={addItem}>
          <FormControl variant='filled'>
            ...
            <Select size='small' name='name' labelId='person-of-item-label' label='Select A Person' defaultValue='' onChange={({ target }) => setName(target.value)} required align='left'>
            ...
            < br />
            <TextField variant='filled' label='Item Name' size='small' type='text' name='itemName' value={itemName} onChange={({ target }) => setItemName(target.value)} placeholder='e.g. Pasta' required /><br />
            <TextField variant='filled' label='Item Price' size='small' type='number' name='price' value={price} onChange={({ target }) => setPrice(target.value)} min='0' step='0.01' required
